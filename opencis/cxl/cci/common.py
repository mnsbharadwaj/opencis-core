...
class CCI_FM_API_COMMAND_OPCODE(IntEnum):
    ...
    GET_DOMAIN_VALIDATION_SV_STATE = 0x5104
    SET_DOMAIN_VALIDATION_SV = 0x5105
    GET_VCS_DOMAIN_VALIDATION_SV_STATE = 0x5106
    GET_DOMAIN_VALIDATION_SV = 0x5107
