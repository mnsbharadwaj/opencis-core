...
from opencis.cxl.component.hdm_decoder import PbrHdmDecoderManager, HdmDecoderCapabilities, HDM_DECODER_COUNT, DecoderInfo, INTERLEAVE_GRANULARITY, INTERLEAVE_WAYS
...
async def test_pbr_data_plane_routing():
    ...
    try:
        ...
        spid = 0x011
        dpid = 0x123
        pbr_packet = PbrBasePacket.create(spid=spid, dpid=dpid, inner_packet=hbr_packet)
        
        assert pbr_packet.system_header.payload_type == PAYLOAD_TYPE.PBR
